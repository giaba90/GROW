...
const Card = React.forwardRef(({ className, ...props }, ref) => (_jsx("div", { ref: ref, className: cn("md:rounded-xl md:border bg-card text-card-foreground md:shadow", className), ...props })));
